...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      {
        // Standards-compliant variant — apple-mobile-web-app-capable is
        // deprecated in favor of the unprefixed name. Keep both so legacy
        // iOS Safari still picks up the Apple form while modern browsers
        // honor the unprefixed one.
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <GatewayRestartProvider>
        ...
        {/* Voice Hub floating dialer — self-gates to /voice* routes only */}
        <VoiceFloatingButton />
      </GatewayRestartProvider>
    </QueryClientProvider>
  )
        ...
        <script
          ...
          (function(){
            ...
            d.innerHTML = '<div class="sp-aurora"></div><div class="sp-grid"></div><div class="sp-grain"></div><div class="sp-vignette"></div>'
              ...
              + '<div class="sp-badge"><span class="sp-bk tl"></span><span class="sp-bk tr"></span><span class="sp-bk bl"></span><span class="sp-bk br"></span><div class="sp-halo"></div><div class="sp-glow"></div><img class="sp-wave" src="/pulsecheck-wave.svg" alt="PulseCheck" width="245" height="188" decoding="async" fetchpriority="high"/><div class="sp-scanline"></div></div>'
            ...
            style.textContent = '#splash-screen .sp-aurora{position:absolute;inset:-30%;pointer-events:none;filter:blur(64px);opacity:.32;background:radial-gradient(40% 40% at 22% 30%,rgba(255,107,53,.28),transparent 62%),radial-gradient(36% 36% at 82% 24%,rgba(46,150,255,.14),transparent 62%),radial-gradient(48% 48% at 70% 82%,rgba(255,107,53,.16),transparent 64%)}#splash-screen .sp-grid{position:absolute;inset:0;pointer-events:none;background-image:linear-gradient(rgba(255,107,53,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(255,107,53,.035) 1px,transparent 1px);background-size:60px 60px;-webkit-mask-image:radial-gradient(circle at 50% 50%,#000,transparent 68%);mask-image:radial-gradient(circle at 50% 50%,#000,transparent 68%)}#splash-screen .sp-grain{position:absolute;inset:0;pointer-events:none;opacity:.035;mix-blend-mode:overlay;background-image:url("data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22160%22 height=%22160%22%3E%3Cfilter id=%22ns%22%3E%3CfeTurbulence type=%22fractalNoise%22 baseFrequency=%220.8%22 numOctaves=%224%22 stitchTiles=%22stitch%22/%3E%3C/filter%3E%3Crect width=%22100%25%22 height=%22100%25%22 filter=%22url(%23ns)%22/%3E%3C/svg%3E")}#splash-screen .sp-vignette{position:absolute;inset:0;pointer-events:none;background:radial-gradient(130% 100% at 50% 50%,transparent 52%,rgba(0,0,0,.55))}#splash-screen .sp-stack{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center}#splash-screen .sp-term{width:300px;max-width:80vw;margin-bottom:32px;font:500 12px/1.75 ui-monospace,"SF Mono",Menlo,Consolas,monospace;color:var(--sp-muted)}#splash-screen .sp-line{display:flex;align-items:center;gap:8px;opacity:1}#splash-screen .sp-k{color:#9FB3CC;white-space:nowrap}#splash-screen .sp-dots{flex:1;height:1px;background:repeating-linear-gradient(90deg,rgba(255,107,53,.22) 0 2px,transparent 2px 6px)}#splash-screen .sp-ok{color:#FFB547;font-weight:600;letter-spacing:.14em}#splash-screen .sp-badge{position:relative;display:flex;align-items:center;justify-content:center;padding:24px 32px;overflow:visible;isolation:isolate}#splash-screen .sp-bk{position:absolute;width:14px;height:14px;border:1px solid rgba(255,107,53,.45);opacity:.85}#splash-screen .sp-bk.tl{top:0;left:0;border-right:0;border-bottom:0}#splash-screen .sp-bk.tr{top:0;right:0;border-left:0;border-bottom:0}#splash-screen .sp-bk.bl{bottom:0;left:0;border-right:0;border-top:0}#splash-screen .sp-bk.br{bottom:0;right:0;border-left:0;border-top:0}#splash-screen .sp-wave{display:block;width:180px;height:auto;position:relative;z-index:2;image-rendering:auto;will-change:transform,opacity}#splash-screen .sp-halo{position:absolute;top:50%;left:50%;width:340px;height:300px;border-radius:50%;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(255,107,53,.22),rgba(255,107,53,.06) 38%,transparent 68%);pointer-events:none;z-index:0;filter:blur(8px)}#splash-screen .sp-glow{position:absolute;top:50%;left:50%;width:240px;height:210px;border-radius:50%;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(255,107,53,.18),rgba(46,150,255,.05) 50%,transparent 72%);pointer-events:none;z-index:1}#splash-screen .sp-scanline{position:absolute;left:12px;right:12px;top:0;height:1px;z-index:3;pointer-events:none;background:linear-gradient(90deg,transparent,rgba(255,107,53,.7),transparent);box-shadow:0 0 8px rgba(255,107,53,.5);opacity:0}#splash-screen .sp-word{margin-top:28px;font:600 30px/1 "Bricolage Grotesque",ui-sans-serif,system-ui,-apple-system,sans-serif;letter-spacing:-.015em;color:var(--sp-txt);font-feature-settings:"ss01" on,"cv11" on}#splash-screen .sp-word .os{background:linear-gradient(95deg,#FF6B35 0%,#FF9F1C 55%,#FFD166 100%);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent}#splash-screen .sp-eyebrow{margin-top:14px;font:500 10px/1 ui-monospace,"SF Mono",Menlo,Consolas,monospace;letter-spacing:.42em;text-transform:uppercase;color:#7FB7C4;opacity:.7}#splash-screen .sp-prog{margin-top:36px;display:flex;align-items:center;gap:14px}#splash-screen .sp-track{position:relative;width:220px;height:2px;border-radius:2px;overflow:hidden;background:rgba(255,107,53,.1)}#splash-screen #splash-bar{width:0%;height:100%;border-radius:2px;background:linear-gradient(90deg,#FF6B35,#FF9F1C,#FFD166);transition:width .3s cubic-bezier(.4,0,.2,1);box-shadow:0 0 10px rgba(255,107,53,.5)}#splash-screen .sp-pct{font:500 10px/1 ui-monospace,"SF Mono",Menlo,monospace;color:var(--sp-muted);min-width:30px;text-align:left;letter-spacing:.1em;font-variant-numeric:tabular-nums}#splash-screen .sp-shimmer{position:absolute;top:0;left:-100%;width:100%;height:100%;background:linear-gradient(90deg,transparent,rgba(255,255,255,.28),transparent)}@media (prefers-reduced-motion:no-preference){#splash-screen .sp-aurora{animation:spAurora 22s ease-in-out infinite alternate}#splash-screen .sp-halo{animation:spHalo 4.2s ease-in-out infinite}#splash-screen .sp-glow{animation:spGlow 3.4s ease-in-out infinite}#splash-screen .sp-wave{animation:spWaveIn .9s cubic-bezier(.2,.7,.2,1) both,spWavePulse 3.2s ease-in-out 1.1s infinite}#splash-screen .sp-badge{animation:spBadge .7s cubic-bezier(.2,.7,.2,1) both}#splash-screen .sp-scanline{animation:spScan 1.4s ease .85s 1 both}#splash-screen .sp-line{opacity:0;animation:spLine .3s ease forwards}#splash-screen .sp-shimmer{animation:spShimmer 1.9s ease-in-out infinite}}@media (prefers-reduced-motion:reduce){#splash-screen .sp-aurora,#splash-screen .sp-halo,#splash-screen .sp-glow,#splash-screen .sp-wave,#splash-screen .sp-scanline,#splash-screen .sp-shimmer,#splash-screen .sp-line{animation:none!important}#splash-screen .sp-line{opacity:1}}@keyframes spAurora{0%{transform:translate3d(-2%,-1%,0) scale(1)}100%{transform:translate3d(3%,2%,0) scale(1.06)}}@keyframes spHalo{0%,100%{opacity:.85;transform:translate(-50%,-50%) scale(1)}50%{opacity:1;transform:translate(-50%,-50%) scale(1.05)}}@keyframes spGlow{0%,100%{opacity:.6;transform:translate(-50%,-50%) scale(1)}50%{opacity:.95;transform:translate(-50%,-50%) scale(1.08)}}@keyframes spWaveIn{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:none}}@keyframes spWavePulse{0%,100%{opacity:.92}50%{opacity:1}}@keyframes spBadge{from{opacity:0;transform:scale(.94)}to{opacity:1;transform:none}}@keyframes spScan{0%{top:0;opacity:0}14%{opacity:1}100%{top:100%;opacity:0}}@keyframes spLine{from{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@keyframes spShimmer{0%{left:-100%}60%,100%{left:130%}}';
