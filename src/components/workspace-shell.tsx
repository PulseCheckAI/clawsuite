    ...
    queryFn: async () => {
      ...
      try {
        ...
        throw error instanceof Error
          ? error
          : new Error('Failed to connect to PulseOS server')
      } finally {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-surface">
        <div className="text-center">
          ...
          <p className="text-sm text-primary-500">Initializing PulseOS...</p>
        </div>
      </div>
    )
  }
  ...
  if (authQuery.isError) {
    const errorMessage =
      authQuery.error instanceof Error
        ...
        : 'Failed to connect to PulseOS server'
      ...
      <div className="flex h-screen items-center justify-center bg-surface px-6">
        <div className="w-full max-w-lg text-center">
          ...
          <h1 className="text-2xl font-semibold text-primary-100">
            Could not connect to PulseOS server
          </h1>
  ...
  return (
    <>
      ...
      >
        ...
        {isElectron && (
          <div
            className="absolute inset-x-0 top-0 flex h-10 items-center border-b border-primary-200 dark:border-primary-800 bg-primary-100 dark:bg-primary-900 z-40"
          ...
          >
            ...
            <div className="flex-1 text-center">
              <span className="text-[13px] font-medium text-primary-600 dark:text-primary-400 select-none">PulseOS</span>
            </div>
