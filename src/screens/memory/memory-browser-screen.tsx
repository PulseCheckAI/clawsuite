...
export function MemoryBrowserScreen() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-primary-50 text-primary-900 dark:bg-primary-950 dark:text-primary-100">
      <div className="border-b border-primary-200 bg-primary-50 px-3 py-3 dark:border-primary-800 dark:bg-primary-950 md:px-4">
        <div className="flex items-center gap-3">
          <div className="inline-flex size-9 items-center justify-center rounded-xl border border-primary-200 bg-white text-primary-700 dark:border-primary-800 dark:bg-primary-900 dark:text-primary-200">
          ...
          <div className="min-w-0 flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-primary-200 bg-white py-2 pl-9 pr-3 text-sm text-primary-900 outline-none transition-colors placeholder:text-primary-400 focus:border-accent-500 dark:border-primary-700 dark:bg-primary-900 dark:text-primary-100 dark:placeholder:text-primary-500"
              />
            </div>
          </div>
        </div>
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 p-3 md:grid-cols-3 md:p-4">
        <aside className="flex min-h-0 flex-col rounded-2xl border border-primary-200 bg-primary-50 dark:border-primary-800 dark:bg-primary-950 md:col-span-1">
          <button
            type="button"
          ...
          {searchEnabled ? (
            <div className="min-h-0 flex-1 overflow-y-auto px-2 pb-2">
              <div className="mb-2 px-1 text-[11px] font-semibold uppercase tracking-wide text-primary-400 dark:text-primary-500">
                Search Results
              </div>
              <div className="space-y-1">
                {searchQuery.isLoading ? (
                  <div className="rounded-lg border border-primary-200 bg-primary-50/80 px-3 py-2 text-xs text-primary-400 dark:border-primary-800 dark:bg-primary-900/60 dark:text-primary-500">
                    Searching...
                  </div>
                  ...
                  searchResults.map((result, index) => (
                    <button
                      ...
                      className="w-full rounded-lg border border-primary-200 bg-primary-50/80 px-2.5 py-2 text-left hover:border-primary-300 hover:bg-primary-100 dark:border-primary-800 dark:bg-primary-900/60 dark:hover:border-primary-700 dark:hover:bg-primary-900"
                    >
                      <div className="truncate text-[11px] text-primary-500 dark:text-primary-400">
            ...
            <div className={cn('min-h-0 flex-1 px-2 pb-2', !mobileFilesOpen && 'hidden md:block')}>
              <div className="max-h-72 space-y-1 overflow-y-auto pr-1 md:h-full md:max-h-none">
                ...
                <div className="px-1 pt-2 text-[11px] font-semibold uppercase tracking-wide text-primary-400 dark:text-primary-500">
                  memory/
                </div>
        ...
        <section className="min-h-0 rounded-2xl border border-primary-200 bg-primary-50 dark:border-primary-800 dark:bg-primary-950 md:col-span-2">
          <div className="flex items-center justify-between border-b border-primary-200 px-3 py-2 dark:border-primary-800">
            <div className="min-w-0">
              <div className="truncate font-mono text-sm text-primary-900 dark:text-primary-100">
                ...
                {isEditing ? (
                  <>
                    ...
                    <button
                      ...
                      className="rounded-md border border-primary-200 bg-white px-3 py-1.5 text-xs font-semibold text-primary-700 transition-colors hover:border-primary-300 hover:bg-primary-200 disabled:cursor-not-allowed disabled:opacity-50 dark:border-primary-700 dark:bg-primary-900 dark:text-primary-200 dark:hover:border-primary-600 dark:hover:bg-primary-800"
                    >
                      Cancel
                    </button>
                    {hasUnsavedChanges ? (
          ...
          <div className={cn('h-full p-2 md:p-3', isEditing ? 'overflow-hidden' : 'overflow-auto')}>
            {filesQuery.isLoading ? (
              ...
              <div className="h-full rounded-xl border border-primary-200 bg-primary-50 p-2 dark:border-primary-800 dark:bg-primary-950">
                <textarea
                  value={draftContent}
                  onChange={(event) => {
                  ...
                  className="h-full w-full resize-none rounded-lg border border-primary-800 bg-primary-50 px-3 py-2 font-mono text-[13px] text-primary-900 outline-none ring-0 placeholder:text-primary-500 dark:border-primary-300 dark:bg-primary-50 dark:text-primary-100"
                  spellCheck={false}
                />
              </div>
            ) : (
                  ...
                  {lines.map((line, index) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          'grid grid-cols-[56px_1fr] gap-0 border-b border-primary-200/80 last:border-b-0 dark:border-primary-900/80',
