...
export function NotificationsPopover() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open ? (
        <div className="absolute right-0 top-full z-[9999] mt-2 w-72 rounded-xl border border-primary-200 bg-primary-50 p-3 shadow-xl backdrop-blur-xl dark:border-primary-700 dark:bg-primary-900">
          <h3 className="mb-2 text-xs font-medium uppercase tracking-wide text-primary-500 dark:text-primary-400">
            Notifications
          </h3>
