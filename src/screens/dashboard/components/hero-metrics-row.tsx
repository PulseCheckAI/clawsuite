  ...
  return (
    <div className="mb-3 grid grid-cols-2 gap-2 md:mb-4 md:gap-4 md:grid-cols-4">
      {metrics.map((m) => (
        <div
          key={m.label}
          className="group flex items-center gap-2 md:gap-3 rounded-xl border border-primary-200 bg-primary-50 px-2.5 py-2 md:px-4 md:py-3.5 shadow-sm transition-transform duration-150 hover:-translate-y-[1px] dark:border-primary-700 dark:bg-primary-900"
        >
