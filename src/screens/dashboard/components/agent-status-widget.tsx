...
export function AgentStatusWidget({
  ...
  return (
    <DashboardGlassCard
      ...
      draggable={draggable}
      onRemove={onRemove}
      className="h-full rounded-xl border border-primary-200 dark:border-primary-700 border-l-4 border-l-teal-500 bg-white dark:bg-primary-900 p-3.5 md:p-4 shadow-sm"
    >
