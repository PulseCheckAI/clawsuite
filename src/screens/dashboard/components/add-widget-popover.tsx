  ...
  return (
    <div className="relative">
      ...
      {open ? (
        <div
          ref={popoverRef}
          className="absolute right-0 top-full z-[9999] mt-2 w-64 rounded-xl border border-primary-200 bg-primary-50 p-3 shadow-xl backdrop-blur-xl dark:border-primary-700 dark:bg-primary-900"
        >
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded p-0.5 text-primary-400 hover:text-primary-700 dark:hover:text-primary-200"
            >
