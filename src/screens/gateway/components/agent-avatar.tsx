...
// Agent persona color tokens — avatar bg uses bg-{color}-500/10 dark-mode-
// compatible tints (matches the navy theme; was light pastels before).
export const AGENT_ACCENT_COLORS: AgentAccentColor[] = [
  {
    bar: 'bg-accent-500',
    border: 'border-accent-500',
    avatar: 'bg-accent-500/10',
