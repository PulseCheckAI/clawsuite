...
export const AGENT_ACCENT_COLORS: AgentAccentColor[] = [
  ...
  { bar: 'bg-emerald-500', border: 'border-emerald-500', avatar: 'bg-emerald-500/10', text: 'text-emerald-600', ring: 'ring-emerald-500/20' },
  { bar: 'bg-rose-500', border: 'border-rose-500', avatar: 'bg-rose-100', text: 'text-rose-600', ring: 'ring-rose-500/20' },
  { bar: 'bg-amber-500', border: 'border-amber-500', avatar: 'bg-amber-500/10', text: 'text-amber-300', ring: 'ring-amber-500/20' },
