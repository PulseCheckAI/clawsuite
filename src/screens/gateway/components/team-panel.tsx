...
const MODEL_BADGE_COLOR: Record<ModelPresetId, string> = {
  auto: 'bg-[rgba(255,255,255,0.06)] text-white/80',
  opus: 'bg-accent-500/10 text-accent-400',
  sonnet: 'bg-blue-500/10 text-blue-400',
  codex: 'bg-emerald-500/10 text-emerald-400',
  flash: 'bg-violet-500/10 text-violet-400',
  minimax: 'bg-amber-500/10 text-amber-300',
  'pc1-coder': 'bg-cyan-500/10 text-cyan-400',
  'pc1-planner': 'bg-indigo-500/10 text-indigo-400',
  'pc1-critic': 'bg-purple-500/10 text-purple-400',
}

const DEFAULT_MODEL_BADGE_COLOR = 'bg-primary-100 text-primary-700'
