...
> = {
  ...
  xai: {
    label: 'xAI',
    emoji: '⚡',
    color: 'text-primary-800 dark:text-primary-100',
    bg: 'bg-primary-100 dark:bg-primary-800',
    border: 'border-primary-400',
...
export function WizardModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          'relative w-full rounded-2xl border border-primary-200 dark:border-primary-700 bg-white dark:bg-primary-900 shadow-2xl',
...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="mb-1 block text-[10px] font-semibold uppercase tracking-wide text-primary-400 dark:text-primary-500">
      {children}
    </span>
  )
}
...
const INPUT_CLS =
  'h-9 w-full rounded-lg border border-primary-200 bg-white dark:border-primary-700 dark:bg-primary-800 px-3 text-sm text-primary-900 dark:text-white outline-none ring-accent-400 focus:ring-1 transition-colors'
const SELECT_CLS =
  'h-9 w-full rounded-lg border border-primary-200 bg-white dark:border-primary-700 dark:bg-primary-800 px-3 text-sm text-primary-900 dark:text-white outline-none ring-accent-400 focus:ring-1'
...
export function AgentWizardModal({
  ...
  return (
    <WizardModal open onClose={onClose} width="max-w-2xl">
      ...
      <div
        className={cn(
          'flex items-center gap-4 border-b border-primary-100 dark:border-primary-800 px-6 py-5 border-l-4',
          accentBorderClass,
        )}
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex size-7 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-800 text-primary-500 hover:text-primary-700 dark:hover:text-white transition-colors"
        >
      ...
      <div className="px-6 py-5 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="h-10 w-full rounded-lg border border-primary-200 bg-white dark:border-primary-700 dark:bg-primary-800 px-3 text-base font-semibold text-primary-900 dark:text-white outline-none ring-accent-400 focus:ring-1 transition-colors"
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div>
            <FieldLabel>
              Memory Path{' '}
              <span className="text-[9px] text-primary-400 font-normal">
                (optional)
              </span>
            </FieldLabel>
            <input
            ...
            />
            <p className="mt-0.5 text-[9px] text-primary-400">
        ...
        <div>
            ...
            <div className="flex gap-1.5">
              ...
              {member.backstory.trim() ? (
                <button
                  ...
                  className="rounded-md border border-primary-200 dark:border-primary-700 px-1.5 py-0.5 text-[9px] text-primary-400 hover:text-red-500 transition-colors"
                >
                  ✕ Clear
                </button>
              ) : null}
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          active
                            ...
                            : 'border-primary-200 dark:border-primary-700 bg-white dark:bg-primary-800 text-primary-500 hover:border-primary-300 hover:bg-primary-50 dark:hover:bg-primary-700',
                        )}
          ...
          <textarea
            ...
            className="mt-2 w-full resize-none rounded-lg border border-primary-200 bg-white dark:border-primary-700 dark:bg-primary-800 px-3 py-2.5 text-xs text-primary-900 dark:text-white outline-none ring-accent-400 focus:ring-1 font-mono leading-relaxed overflow-auto"
      ...
      {/* Footer */}
      <div className="flex items-center justify-between gap-3 border-t border-primary-100 dark:border-primary-800 px-6 py-4">
        <button
          type="button"
          onClick={onDelete}
          className={cn(
...
function TeamIconPicker({
  ...
  return (
    <div className="absolute left-0 top-full mt-1 z-[60] rounded-xl border border-primary-200 dark:border-primary-700 bg-white dark:bg-primary-900 shadow-xl p-2 w-52">
    ...
    <WizardModal open onClose={onClose} width="max-w-lg">
      ...
      >
        ...
        <div className="relative shrink-0">
          <div className="flex size-14 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-800 text-3xl shadow-sm">
            {icon}
          </div>
          <button
            type="button"
            onClick={() => setShowIconPicker((v) => !v)}
            className="absolute -bottom-0.5 -right-0.5 flex size-5 items-center justify-center rounded-full border-2 border-white dark:border-primary-900 bg-primary-700 text-white shadow-md hover:bg-primary-600 transition-colors"
            title="Change icon"
          >
        ...
        <button
          ...
          className={cn(
            ...
            isActive
              ...
              : 'text-primary-300 hover:text-accent-400 cursor-pointer',
          )}
        >
          {isActive ? '⭐' : '☆'}
        </button>
        ...
        <div>
          ...
          <div className="space-y-1.5">
            {localMembers.length === 0 ? (
              <p className="rounded-lg border border-dashed border-primary-200 dark:border-primary-700 py-3 text-center text-xs text-primary-400">
              ...
              localMembers.map((member) => (
                <div
                  key={member.id}
                  className="flex items-center gap-2.5 rounded-lg border border-primary-100 dark:border-primary-800 bg-primary-50 dark:bg-primary-800/50 px-3 py-2.5"
                >
                  ...
                  <p className="min-w-0 flex-1 text-xs font-semibold text-primary-900 dark:text-white truncate">
                    {member.name}
                  </p>
                  <button
                    type="button"
                    onClick={() => removeAgent(member.id)}
                    className="flex size-6 items-center justify-center rounded-full text-primary-300 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 transition-colors"
          ...
          {notInTeam.length > 0 && localMembers.length > 0 ? (
            <p className="mt-1 text-center text-[9px] text-primary-400">
        ...
        {notInTeam.length > 0 ? (
          <div>
            <div className="flex items-center gap-2 my-1">
              <div className="flex-1 h-px bg-primary-100 dark:bg-primary-800" />
              <span className="text-[9px] font-semibold uppercase tracking-widest text-primary-400">
                Add Agents
              </span>
              <div className="flex-1 h-px bg-primary-100 dark:bg-primary-800" />
            </div>
            <div className="space-y-1.5">
              {notInTeam.map((agent) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs text-primary-700 dark:text-primary-200 font-medium">
                      {agent.name}
                    </p>
                    {agent.role ? (
...
export function AddTeamModal({
  ...
  return (
    <WizardModal open onClose={onClose} width="max-w-lg">
      {/* Header */}
      <div className="flex items-center gap-4 border-b border-primary-100 dark:border-primary-800 px-6 py-5 border-l-4 border-l-accent-400">
        ...
        <div className="flex-1">
          <p className="text-base font-bold text-primary-900 dark:text-white">
            New Team
          </p>
          <p className="text-xs text-primary-500 dark:text-primary-400">
            {stepLabel}
      ...
      {step === 1 ? (
        <>
          <div className="px-6 py-8">
            <p className="mb-5 text-xl font-bold text-primary-900 dark:text-white">
              Name your team
            </p>
            <input
              ref={nameInputRef}
              ...
              className="h-11 w-full rounded-lg border border-primary-200 dark:border-primary-700 bg-white dark:bg-primary-800 px-4 text-sm text-primary-900 dark:text-white outline-none ring-accent-400 focus:ring-2 transition-colors"
            />
            <p className="mt-2 text-xs text-primary-400 dark:text-primary-500">
              You can change this later
            </p>
          </div>
          <div className="flex justify-end border-t border-primary-100 dark:border-primary-800 px-6 py-4">
            <button
              type="button"
              onClick={() => setStep(2)}
      ...
      {step === 2 ? (
        <>
          <div className="px-6 py-6">
            <p className="mb-4 text-xl font-bold text-primary-900 dark:text-white">
              Choose a picture
            </p>
          ...
          <div className="flex items-center justify-between border-t border-primary-100 dark:border-primary-800 px-6 py-4">
            <button
              type="button"
              onClick={() => setStep(1)}
              className="rounded-lg border border-primary-200 dark:border-primary-700 px-4 py-2 text-xs font-medium text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-800 transition-colors"
            >
              ← Back
            </button>
            <button
      ...
      {step === 3 ? (
        <>
          <div className="px-6 py-5 max-h-[65vh] overflow-y-auto space-y-4">
            {/* Templates section */}
            <div>
              <p className="mb-2 text-xs font-semibold text-primary-500 dark:text-primary-400 uppercase tracking-wide">
              ...
              <div className="grid grid-cols-2 gap-2">
                {quickStartTemplates.map((tpl) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-[11px] font-semibold text-primary-800 dark:text-primary-100 truncate">
                        {tpl.label}
                      </p>
                      <p className="text-[9px] text-primary-400 truncate mt-0.5">
                        {tpl.description}
                      </p>
                    </div>
                    <span
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 border-t border-primary-200 dark:border-primary-700" />
              <span className="text-[10px] text-primary-400 dark:text-primary-500 whitespace-nowrap">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {currentTeam.length === 0 ? (
                  <p className="text-center text-xs text-primary-400 py-3">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          checked
                            ...
                            : 'border-primary-100 dark:border-primary-800 bg-primary-50 dark:bg-primary-800/30 opacity-60 hover:opacity-80',
                        )}
                      >
                        <span
                          className={cn(
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-xs font-semibold text-primary-800 dark:text-primary-100 truncate leading-tight">
                            {m.name}
                          </p>
                        ...
                        <span className="shrink-0 rounded-full border border-primary-200 dark:border-primary-700 bg-primary-50 dark:bg-primary-800 px-1.5 py-0.5 text-[9px] font-medium text-primary-500 dark:text-primary-400">
                          {modelShort}
                        </span>
                      </button>
                    )
    ...
    <WizardModal open onClose={onClose} width="max-w-md">
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="flex size-7 shrink-0 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-800 text-primary-500 hover:text-primary-700 dark:hover:text-white transition-colors"
        >
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
            <path
              d="M1 1l8 8M9 1L1 9"
      ...
      <div className="px-6 py-5 space-y-4">
        ...
        {currentModels.length > 0 ? (
          <div>
            ...
            <div className="rounded-lg border border-primary-100 dark:border-primary-800 bg-primary-50 dark:bg-primary-800/50 p-2 max-h-36 overflow-y-auto">
              {currentModels.map((m) => (
                <div
                  key={m.value}
                ...
                >
                  ...
                  <span className="text-[11px] text-primary-600 dark:text-primary-400 truncate">
                    {m.label}
                  </span>
                </div>
              ))}
            ...
            <div>
              <FieldLabel>
                ...
                {availableModels.length === 0 ? (
                  <span className="font-normal normal-case text-primary-300 dark:text-primary-600">
                    — common models
                  </span>
                ) : null}
              </FieldLabel>
      ...
      <div className="flex items-center justify-between gap-2 border-t border-primary-100 dark:border-primary-800 px-6 py-4">
        <div>
          {onDelete ? (
            <button
              type="button"
